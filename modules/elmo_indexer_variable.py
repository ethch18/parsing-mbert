...
class VariableLengthELMoCharacterMapper:
    """
    Adapted from Rosita's PreloadedElmoCharacterMapper
    """
    ...
    def __init__(self,
        ...
        self.tokens_to_add = tokens_to_add or {}
        self.max_word_length = VariableLengthELMoCharacterMapper.max_word_length
        self.char_map = {}
...
@TokenIndexer.register("elmo_characters_variable")
class ELMoTokenCharactersIndexer(TokenIndexer[List[int]]):
    ...
    def __init__(self,
                 ...
                 char_map_file: str = None) -> None:
        super().__init__(token_min_padding_length)
        self._namespace = namespace
        if char_map_file is not None:
            self._mapper = VariableLengthELMoCharacterMapper(char_map_file,
                                                             tokens_to_add)
        else:
