...
from .data import Vocabulary, UnicodeCharsVocabulary, \
        InvalidNumberOfCharacters, VariableSizeCharsVocabulary
...
def load_vocab(vocab_file, max_word_length=None, variable=False):
    if variable:
        if max_word_length is None:
            raise "Variable length vocab needs max word length"
        return VariableSizeCharsVocabulary(vocab_file, max_word_length,
                validate_file=True)
    if max_word_length:
